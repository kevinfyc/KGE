namespace kge
{
...
#else
		return Vector3(
			v2.x * m[0][0] + v2.y * m[0][1] + v2.z * m[0][2] + m[0][3],
			v2.x * m[1][0] + v2.y * m[1][1] + v2.z * m[1][2] + m[1][3],
			v2.x * m[2][0] + v2.y * m[2][1] + v2.z * m[2][2] + m[2][3]);
#endif
#endif
    }
...
#else
		v1.x = v2.x * m[0][0] + v2.y * m[0][1] + v2.z * m[0][2] + m[0][3];
		v1.y = v2.x * m[1][0] + v2.y * m[1][1] + v2.z * m[1][2] + m[1][3];
		v1.z = v2.x * m[2][0] + v2.y * m[2][1] + v2.z * m[2][2] + m[2][3];
#endif
#endif
    }
...
#else
		v1[0] = v2[0] * m[0][0] + v2[1] * m[0][1] + v2[2] * m[0][2] + m[0][3];
		v1[1] = v2[0] * m[1][0] + v2[1] * m[1][1] + v2[2] * m[1][2] + m[1][3];
		v1[2] = v2[0] * m[2][0] + v2[1] * m[2][1] + v2[2] * m[2][2] + m[2][3];
		v1[3] = v2[0] * m[3][0] + v2[1] * m[3][1] + v2[2] * m[3][2] + m[3][3];
#endif
#endif
    }
...
#else
		v1[0] = v2[0] * m[0][0] + v2[1] * m[0][1] + v2[2] * m[0][2] + v2[3] * m[0][3];
		v1[1] = v2[0] * m[1][0] + v2[1] * m[1][1] + v2[2] * m[1][2] + v2[3] * m[1][3];
		v1[2] = v2[0] * m[2][0] + v2[1] * m[2][1] + v2[2] * m[2][2] + v2[3] * m[2][3];
		v1[3] = v2[0] * m[3][0] + v2[1] * m[3][1] + v2[2] * m[3][2] + v2[3] * m[3][3];
#endif
#endif
    }
...
#else
		return Vector3(
			v2.x * m[0][0] + v2.y * m[0][1] + v2.z * m[0][2],
			v2.x * m[1][0] + v2.y * m[1][1] + v2.z * m[1][2],
			v2.x * m[2][0] + v2.y * m[2][1] + v2.z * m[2][2]);
#endif
#endif
    }
    ...
    INLINE float Matrix::pitch() const
    {
        ...
        return -asin( zdir.y );
#else
        return -asinf( clamp(-1.0f, zdir.y, +1.0f) );
#endif
    }
    ...
    INLINE float Matrix::roll() const
    {
        ...
        roll = acos( acarg );
#else
        roll = acosf( clamp(-1.0f, acarg, +1.0f) );
#endif
